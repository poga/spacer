...
// libLogLua reads file data from disk. It returns an error on failure.
func libLogLua() (*asset, error) {
	path := "/Users/poga/projects/go/src/github.com/poga/spacer/lib/log.lua"
	name := "lib/log.lua"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"lib": &bintree{nil, map[string]*bintree{
		...
		"log.lua": &bintree{libLogLua, map[string]*bintree{}},
