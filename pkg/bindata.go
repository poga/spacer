...
// appNginxConf reads file data from disk. It returns an error on failure.
func appNginxConf() (*asset, error) {
	path := "/Users/poga/projects/go/src/github.com/poga/spacer/app/nginx.conf"
	name := "app/nginx.conf"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
...
var _bintree = &bintree{nil, map[string]*bintree{
	"app": &bintree{nil, map[string]*bintree{
		...
		"nginx.conf": &bintree{appNginxConf, map[string]*bintree{}},
