...
// appRoutesLua reads file data from disk. It returns an error on failure.
func appRoutesLua() (*asset, error) {
	path := "/Users/poga/projects/go/src/github.com/poga/spacer/app/routes.lua"
	name := "app/routes.lua"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
...
var _bintree = &bintree{nil, map[string]*bintree{
	"app": &bintree{nil, map[string]*bintree{
		...
		"routes.lua": &bintree{appRoutesLua, map[string]*bintree{}},
