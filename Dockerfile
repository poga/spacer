# Modified from https://github.com/openresty/docker-openresty/blob/master/stretch/Dockerfile
...
RUN wget -qO - http://packages.confluent.io/deb/4.0/archive.key | apt-key add - \
    ...
    && DEBIAN_FRONTEND=noninteractive apt-get install librdkafka1 librdkafka++1 librdkafka-dev
